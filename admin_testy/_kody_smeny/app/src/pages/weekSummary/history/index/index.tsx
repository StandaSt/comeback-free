...
import weekSummaryHistoryBreadcrumbs from './breadcrumbs';
import weekSummaryHistoryResources from './resources';
...
const WeekSummaryHistory: React.FC = () => {
  ...
  return (
    <Paper title="Naplánované směny - Historie">
      <MaterialTable
        isLoading={loading}
        columns={[
          {
        ...
        actions={[
          {
            ...
            onClick: (_, row) => {
              router.push({
                pathname: routes.weekSummary.history.week,
