...
if (!function_exists('db_user_role_sync')) {
    ...
    function db_user_role_sync(mysqli $conn, int $idUser, array $profile, bool $updateSession = true): array
    {
        ...
        // Ochrana systémového administrátora: import ze Směn nesmí uživateli 1
        // omylem odebrat roli Admin. U ostatních rozhoduje výhradně mapování rolí ze Směn.
        if ($idUser === 1) {
        ...
        // 7) sub_role = 4 nebo 5 (vedouci pobocky / vedouci smeny)
