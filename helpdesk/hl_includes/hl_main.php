...
(function () {
  ...
  function getExpandedBox() {
    var overlayExpanded = document.querySelector('.helpdesk_module_content [data-card-expanded]');
...
<style>
  ...
  .helpdesk_module_menu_btn.is-active{
    border-color:#60a5fa;
    background:#dbeafe;
  }

  .helpdesk_module_content{
    min-width:0;
    min-height:0;
    padding:8px 8px 8px 0;
  }

  .helpdesk_module_content > .cb-hd-card-min{
    display:none;
  }

  .helpdesk_module_content .cb-hd-card-max{
    min-height:calc(100vh - 83px);
  }
</style>
<div class="helpdesk_module_page">
  <nav class="helpdesk_module_menu" aria-label="HelpDesk menu">
    <h2 class="helpdesk_module_menu_title">HelpDesk</h2>
    <button type="button" class="helpdesk_module_menu_btn is-active">Přehled</button>
    <button type="button" class="helpdesk_module_menu_btn">Nový tiket</button>
    <button type="button" class="helpdesk_module_menu_btn">Moje tikety</button>
    <button type="button" class="helpdesk_module_menu_btn">Sledované</button>
    <button type="button" class="helpdesk_module_menu_btn">Uzavřené</button>
    <?php if ($isAdmin): ?>
      <button type="button" class="helpdesk_module_menu_btn">Admin</button>
    <?php endif; ?>
  </nav>
  <section class="helpdesk_module_content">
    <?= $card_min_html ?>
    <?= $card_max_html ?>
  </section>
</div>
