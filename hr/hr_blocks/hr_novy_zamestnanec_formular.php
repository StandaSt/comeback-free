        ...
        <section class="hr_new_employee_section">
            ...
            <table class="hr_new_employee_table"><tbody>
                ...
                <tr>
                    ...
                    <td class="hr_new_employee_field hr_new_employee_field--main-branch"><label class="hr_form_label"><span>Hlavní pobočka</span><select name="id_pob_hlavni" required disabled data-hr-main-branch><option value="">Nejprve vyberte pobočky</option></select></label></td>
                    <td class="hr_new_employee_field hr_new_employee_field--slot"><label class="hr_form_label"><span>Pozice</span><select name="id_slot" required><option value="">Vyberte</option><?php foreach ($sloty as $slot): ?><option value="<?= h($slot['id']) ?>"><?= h($slot['label']) ?></option><?php endforeach; ?></select></label></td>
