...
<div class="head_branch zaobleni_10 displ_flex jc_stred" aria-label="Pobočka">
  <select id="cbPobockaSelect" class="head_branch_select ram_ovladace txt_seda bg_bila zaobleni_8 text_12 vyska_24 sirka100" data-cb-branch-select="1" <?= $cbPobocky ? '' : 'disabled' ?> >
    <?php if ($cbPobocky): ?>
