...
<div class="head_user ram_hlavicka zaobleni_10 odstup_vnitrni_0 displ_grid"
     ...
     data-logout-url="<?= h(cb_url('index.php?action=logout&duvod=0')) ?>"
  ...
  <a class="head_user_exit cursor_ruka bg_bila zaobleni_6 displ_flex jc_stred" href="<?= h(cb_url('index.php?action=logout&duvod=1')) ?>" aria-label="Odhlásit">
