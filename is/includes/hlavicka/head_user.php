...
<div class="head_user ram_hlavicka zaobleni_10 odstup_vnitrni_0 displ_grid"
     ...
     data-logout-url="<?= h(cb_url('index_is.php?action=logout&duvod=0')) ?>"
     data-touch-url="<?= h(cb_url('index_is.php')) ?>">
  ...
  <div class="head_user_col head_user_col--left txt_l gap_6 displ_flex flex_sloupec">
    ...
    <button type="button" class="head_kpi_toggle txt_c cursor_ruka" data-cb-kpi-toggle="1" data-cb-kpi-state="<?= h((string)(int)cb_user_setting('kpi', 1)) ?>" aria-pressed="false">Skrýt KPI</button>
  </div>
  ...
  <a class="head_user_exit cursor_ruka bg_bila zaobleni_6 displ_flex jc_stred" href="<?= h(cb_url('index_is.php?action=logout&duvod=1')) ?>" aria-label="Odhlásit">
