...
<head>
  ...
  <link rel="stylesheet" href="<?= h(cb_public_url('style/1/modal_alert.css')) ?>">
  <style>
...
(function(){
  ...
  btnPair.addEventListener('click', function(){
    ...
    navigator.serviceWorker.register(<?php echo json_encode(cb_public_url('sw.js'), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?>)
      .then(function(){
