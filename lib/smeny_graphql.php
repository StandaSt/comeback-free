...
function cb_login_load_settings_to_session(int $idUser): void
{
    ...
    $resSystem = $conn->query('SELECT restia_online, on_2fa, system_logout, pauza_obdobi, log_1, log_2, log_3, log_4, notif_chyby, notif_bad_login FROM set_system WHERE id_set = 1 LIMIT 1');
