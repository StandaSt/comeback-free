...
function hrSazbyRender(array $summary, array $intervals, array $result, bool $write): void
{
    ...
    <div class="table-wrap ram_normal bg_bila zaobleni_12 odstup_vnitrni_10">
      ...
      <div class="card_actions gap_8 displ_flex odstup_horni_10">
        <form method="post" action="<?= hrSazbyH(cb_url('/provoz.php')) ?>" class="odstup_vnejsi_0 displ_inline_flex" data-cb-max-form="1" data-cb-loader-text="Počítám HR sazby">
        ...
        <form method="post" action="<?= hrSazbyH(cb_url('/provoz.php')) ?>" class="odstup_vnejsi_0 displ_inline_flex" data-cb-max-form="1">
