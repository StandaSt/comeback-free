...
(function (w) {
  ...
  function reloadRestiaImportMax(cardId, attempt, mode) {
    ...
    const url = (w.CB_ENDPOINT || 'index.php') + '?cb_card_id=' + encodeURIComponent(String(id)) + '&cb_restia_import_max=1';
    fetch(url, {
      method: 'GET',
  ...
  function submitAjax(form, submitter, options) {
    ...
    const reqUrl = String(form.action || w.location.href || (w.CB_ENDPOINT || 'index.php'));
    const tempNodes = [];
