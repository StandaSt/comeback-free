...
$cbScriptTables = [
    ...
    'kontrola_restia_objednavky.php' => [
        'objednavky_kontrola',
        'objednavky_restia',
        'pobocka',
    ],
...
$cbRestiaImportActionHtml = ''
    . '<form method="post" action="' . h(cb_url('/provoz.php')) . '" class="odstup_vnejsi_0" data-cb-max-form="1">'
...
<table class="card_mini_table">
  ...
  <tbody>
    ...
    <tr>
      <td>kontrola_restia_objednavky.php</td>
      <td><?= cb_admin_init_status_html('kontrola_restia_objednavky.php', $cbScriptStats) ?></td>
...
if ($cbRunRestiaKontrola) {
    $cbTraceK3Branch = 'run_restia_kontrola';
    $card_max_html = cb_admin_init_capture_max_include(
