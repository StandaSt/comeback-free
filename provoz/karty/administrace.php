...
$card_min_html = '<p class="card_mini_text">administrace</p>'
    . '<p class="card_mini_text">Zde se nastavují globální parametry systému.</p>'
...
$cbAdminFormAction = cb_url('/provoz.php');
